...
jQuery._farbtastic = function (container, callback) {
  ...
  // Insert markup
  jQuery(container).html('<span class="color-input-picker-close" onclick="jQuery(this).parent().fadeOut(200);"></span><div class="farbtastic"><div class="color"></div><div class="wheel"></div><div class="overlay"></div><div class="h-marker marker"></div><div class="sl-marker marker"></div></div>');

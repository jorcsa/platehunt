...
<p class="select-metabox">
    ...
    <select name="sidebar_position" id="sidebar_position">
    	...
    	<option value="default"<?php if($sidebar_position == 'default') { echo ' selected="selected"'; } ?>><?php _e('Default ('.ddp('sidebar_default').')', 'btoa'); ?></option>
    	<option value="Right Side"<?php if($sidebar_position == 'Right Side') { echo ' selected="selected"'; } ?>><?php _e('Right Side', 'btoa'); ?></option>
    	<option value="Left Side"<?php if($sidebar_position == 'Left Side') { echo ' selected="selected"'; } ?>><?php _e('Left Side', 'btoa'); ?></option>
    	<option value="No Sidebar (Full Width)"<?php if($sidebar_position == 'No Sidebar (Full Width)') { echo ' selected="selected"'; } ?>><?php _e('No Sidebar (Full Width)', 'btoa'); ?></option>
